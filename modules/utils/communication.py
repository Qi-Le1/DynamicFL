...
class Communication:
    def __init__(self, client_ids):
        ...
        if cfg['server_ratio'] == '1-0':
            self.server_communication_cost_budget = float('int')
            self.server_high_freq_communication_cost_budget = float('int')
        else:
    ...
    def cal_client_communication_cost_budget(
        self, 
        model_size, 
        communication_times, 
    ):
    ...
    def cal_server_communication_cost_budget(
        self, 
        model_size, 
        high_freq_client_num, 
        low_freq_client_num, 
