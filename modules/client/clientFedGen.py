...
class ClientFedGen(ClientBase):
    ...
    def train(
        ...
        for i, input in enumerate(data_loader):
            ...
            # apply data augmentation to all batches, according to FedGen
            ...
            # put latent representation into model, run predict layer, get logits
            # print(f'gen_output: {gen_output}, {gen_output.shape}')
