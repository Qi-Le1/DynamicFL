...
class ServerBase:
    ...
    def select_clients(
        ...
        #     self.fix_order_picking += 1
        #     if self.fix_order_picking == cfg['num_clients']:
        #         self.fix_order_picking = 0
        #     selected_client_ids.append(self.fix_order_picking)
    ...
    def extend_data_split(
        ...
        if cfg['algo_mode'] == 'dynamicsgd':
            ...
            while len(new_data_split) <= total_data_size:
                ...
                chosen_eles = np.random.choice(self.data_split[client_id], size=len(self.data_split[client_id]), replace=True)
            ...
            while len(new_data_split) <= total_data_size:
                ...
                chosen_eles = np.random.choice(self.data_split, size=len(self.data_split), replace=True)
                new_data_split.extend(chosen_eles)
