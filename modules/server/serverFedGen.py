...
class ServerFedGen(ServerBase):
    ...
    def __init__(
        ...
        # 创建 generative_optimizer, generative_scheduler
        ...
        def update_generator_(n_iters, TEACHER_LOSS, DIVERSITY_LOSS):
            ...
            for i in range(n_iters):
                ...
                # for user_idx, user in enumerate(self.selected_users):
                    ...
                    # print(f'user_output_logp_ {user_output_logp_.is_cuda}')
                    # print(f'y_input {y_input.is_cuda}')
