        ...
        with torch.no_grad():
            ...
            if valid_clients:
                ...
                for valid_client in valid_clients:
                    ...
                    # print(f'valid_client.a_i is: {valid_client.a_i}', flush=True)
                # print(f'coeff is: {coeff}', flush=True)
                # torch.true_divide(global_model_state_dict[key]-net_para[key], a_i)
                ...
                for k, v in model.named_parameters():
                    ...
                    if 'weight' in parameter_type or 'bias' in parameter_type:
                        ...
                        for m in range(len(valid_clients)):
                            # tmp_v = coeff * weight[m] * torch.true_divide(valid_clients[m].model_state_dict[k] - v.data, valid_clients[m].a_i)
