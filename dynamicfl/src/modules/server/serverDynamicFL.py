...
class ServerDynamicFL(ServerBase):
    ...
    def update_dynamic_part(
        ...
        with torch.no_grad():
            ...
            if target_gradent_update not in self.dynamic_uploaded_clients:
                return
            
            new_model_parameters_list = self.dynamic_iterates[target_gradent_update]
            ...
            # del self.dynamic_iterates[target_gradent_update]
        return
    ...
    def distribute_local_gradient_update_list(self, selected_client_ids: list[int])
        ...
        for ratio, local_gradient_update_list in self.local_gradient_update_dict:
