...
# Missing ./output/result/resnet18_all/1_CIFAR100_resnet18_0.1_100_non-iid-d-0.3_dynamicfl_5_1-0_0.9-0.1_6-1.pt
                ...
                # control_name = [[['CIFAR100'], ['cnn'], ['0.1'], ['100'], ['non-iid-d-0.3'], 
                #                 ['dynamicfl'], ['5'],['1-0'], ['0.3-0.7'], 
                #                 ['5-1']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
...
# Missing ./output/result/freq_ablation/0_CIFAR100_cnn_0.1_100_non-iid-d-0.3_dynamicfl_5_1-0_0.3-0.7_5-1.pt
                ...
                # control_name = [[['CIFAR10'], ['cnn', 'resnet18'], ['0.1'], ['100'], ['non-iid-d-0.1', 'non-iid-l-2'], 
                #         ['fedavg'], ['5'], ['cn', 'pccn']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
                ...
                # random client select
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], [ 'non-iid-l-2'], 
                #         ['dynamicfl'], ['5'], ['0.3-0.7', '0.6-0.4', '0.9-0.1'], ['1-0'], 
                #         [ '6-1', '5-1', '4-1'], ['random', 'dyna']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)

                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-d-0.3'], 
                #         ['dynamicfl'], ['5'], ['0.3-0.7', '0.6-0.4', '0.9-0.1'], ['1-0'],   
                #         [ '6-1', '5-1', '4-1'], ['random', 'dyna']]]
                # CIFAR10_controls_10 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_10)

                # control_name = [[['CIFAR10'], ['resnet18'], ['0.1'], ['100'], ['non-iid-d-0.1'], 
                #         ['dynamicfl'], ['5'], ['1-0'], ['0.3-0.7', '0.6-0.4', '0.9-0.1'],  
                #         [ '6-1', '5-1', '4-1'], ['random']]]
                # CIFAR10_controls_10 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_10)
                ...
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], [ 'non-iid-d-0.1'], 
                #         ['dynamicfl'], ['5'], ['0.3-0.7', '0.6-0.4', '0.9-0.1'],  ['1-0'],  
                #         [ '6-1', '5-1', '4-1'], ['random', 'dyna']]]
                # CIFAR10_controls_10 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_10)
                ...
                # control_name = [[['CIFAR10'], ['resnet18'], ['0.1'], ['100'], ['non-iid-l-2'], 
                #         ['dynamicfl'], ['5'], ['0.1-0.9', '0.2-0.8', '0.3-0.7', '0.4-0.6', '0.5-0.5', '0.6-0.4', '0.7-0.3', '0.8-0.2', '0.9-0.1'], ['1-0'], 
                #         [ '6-1'], ['random', 'dyna']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
                ...
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-l-1', 'non-iid-l-2'], 
                #         ['dynamicfl'], ['5'], ['0.1-0.9', '0.2-0.8', '0.3-0.7', '0.4-0.6', '0.5-0.5', '0.6-0.4', '0.7-0.3', '0.8-0.2', '0.9-0.1'], ['1-0'], 
                #         [ '6-1'], ['gene'], ['noln'], ['999999'], ['0.01']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)

                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-l-2'], 
                #         ['dynamicfl'], ['5'], ['0.1-0.9', '0.2-0.8', '0.3-0.7', '0.4-0.6', '0.5-0.5', '0.6-0.4', '0.7-0.3', '0.8-0.2', '0.9-0.1'], ['1-0'], 
                #         [ '6-1'], ['rand', 'dyna'], ['relu-ln'], ['10', '999999'], ['0.01'], ['noadap']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
                ...
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-l-1', 'non-iid-l-2'], 
                #         ['dynamicfl'], ['5'], ['0.1-0.9', '0.2-0.8', '0.3-0.7', '0.4-0.6', '0.5-0.5', '0.6-0.4', '0.7-0.3', '0.8-0.2', '0.9-0.1'], ['1-0'], 
                #         [ '6-1'], ['rand', 'dyna'], ['noln'], ['10'], ['0.01'], ['adap']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-d-0.1'], 
                #         ['dynamicfl'], ['5'], ['0.2-0.8', '0.3-0.7', '0.4-0.6', '0.5-0.5', '0.6-0.4', '0.7-0.3', '0.8-0.2', '0.9-0.1'], ['1-0'], 
                ...
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-l-1'], 
                #         ['dynamicfl'], ['5'], ['1-0'], ['0.2-0.8', '0.3-0.7', '0.4-0.6', '0.5-0.5', '0.6-0.4', '0.7-0.3', '0.8-0.2', '0.9-0.1'],  
                #         [ '6-1'], ['random', 'dyna']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
                ...
                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-d-0.3'], 
                #         ['dynamicfl'], ['5'], ['0.1-0.9'], ['1-0'], 
                #         [ '4-1'], ['random', 'dyna']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)

                # control_name = [[['CIFAR10'], ['cnn'], ['0.1'], ['100'], ['non-iid-l-2'], 
                #         ['dynamicfl'], ['5'], ['1-0'], ['0.1-0.9'], 
                #         [ '5-1'], ['random', 'dyna']]]
                # CIFAR10_controls_9 = make_controls(script_name, init_seeds, device, resume_mode, control_name)
                # controls.extend(CIFAR10_controls_9)
